...
namespace Ucu.Poo.TelegramBot
{
    ...
    /// </summary>
    public class DuarteHandler : BaseHandler
    {
        ...
        public DuarteHandler(TelegramBotClient bot, BaseHandler next)
            : base(new string[] { "Duarte", "duarte" }, next)
        {
            this.bot = bot;
        }
        ...
        private async Task SendProfileImage(Message message)
        {
            ...
            if (this.bot != null)
            {
                ...
                const string filePath = @"Duarte.jpg";
                ...
                await this.bot.SendPhotoAsync(
                    ...
                    caption: "Con mis habilidades pude entrar al historial de duarte y encontré esto: ");
            }
        }
    }
}